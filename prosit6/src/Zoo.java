...
public class Zoo {
    ...
    public boolean addAquaticAnimal(AquaticAnimal aquaticAnimal) {
        ...
        if (searchAquaticAnimal(aquaticAnimal) != -1) {
            System.out.println("The aquatic animal already exists in the section.");
            return false;
        }
    ...
    public int searchAquaticAnimal(AquaticAnimal aquaticAnimal) {
        int index = -1;
    ...
    {
        System.out.println("All aquatic animals are swimming:");
        for (int i = 0; i < nbrAquaticAnimals; i++)
        {
